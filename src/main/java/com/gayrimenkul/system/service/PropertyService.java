...
public class PropertyService {
    ...
    public List<Property> searchActiveProperties(Long cityId, Long categoryId, BigDecimal min, BigDecimal max) {
        return propertyRepository.filterActiveProperties(cityId, categoryId, min, max);
    }
